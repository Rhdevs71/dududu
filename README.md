...
[**➕ Add Piko to Morphe**](https://morphe.software/add-source?github=Rhdevs71/dududu)
...
<!-- PATCHES_START -->
> **[v1.23.0](https://github.com/Rhdevs71/dududu/releases/tag/v1.23.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;162 patches total
<details>
...
| [Force In-App Subscription Menu](#force-in-app-subscription-menu) | Menyediakan akses langsung ke menu paket langganan internal Flutter (/link/dashboard/subscribe) via Launcher App Shortcut, Status Bar Quick Menu, membuka gateway pembayaran resmi saat paket diklik, serta mencegat redirect web eksternal/webview. |  |
...
<details>
<summary>📦 eFootball&nbsp;&nbsp;•&nbsp;&nbsp;3 patches</summary>
<br>
